...
Here is the link for our iNaturalost Dataset : (https://www.inaturalist.org/observations?project_id=st-olaf-natural-lands&place_id=any&verifiable=any) 
...
This is a leadlet map that pinpoints where the observations were made
...
Creating a bar chart allows us to clearly visualize the most common species, making it easy to compare their relative frequencies. 
...
renderPlot({
  ...
  top_num <- inat_stolaf |>
    ...
    slice(1:as.numeric(input$top_num))
